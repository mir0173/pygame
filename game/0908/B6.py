...
class B6():
    ...
    def tutorial(self, character_left, character_right):
        ...
        inter = 0
        canmove = True
        dialogue(0, self.screen, self.font, protagonist)
            ...
            if not self.pause:
                ...
                if self.screen_number == 1:
                    ...
                    if protagonist.player.right - right_area >= 800:
                        ...
                        k = dialogue(1, self.screen, self.font, protagonist)
                    if k == 1:
                ...
                if self.screen_number == 2:
                    ...
                    if k == 0:
                        ...
                        canmove = False
                        k = dialogue(2, self.screen, self.font, protagonist)
                    if k == 1:
                        pygame.time.wait(1000)
                        protagonist.screen_number += 1
                        self.screen_number += 1
                ...
                if self.screen_number == 4:
                    if k == 0:
                        door_open.play()
                        k = dialogue(3, self.screen, self.font, protagonist)
                    if k == 1:
                        canmove = True
                if self.screen_number == 5:
                    ...
                    canmove = False
                    if n == 0:
                        n = dialogue(4, self.screen, self.font, protagonist)
                    if n == 1:
                        canmove = True
                    if protagonist.player.right - right_area >= 300:
                        ...
                        pygame.time.wait(1000)
                        if m == 0:
                            m = dialogue(5, self.screen, self.font, protagonist)
                        if m == 1:
                            canmove = True
                            update(self.screen, self.font, protagonist)
                            pygame.display.update()
