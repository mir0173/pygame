...
index = [[6,1,0], [6,2,0], [6,2,0], [6,2,0], [6,2,0], [6,3,0], [6,3,0], [5,1,1], [5,1,1], [5,2,1], [5,2,1], [5,2,1], [5,2,1], [5,3,1], [5,3,1], [5,3,1], [5,3,1], [5,4,1], [5,4,1]]
...
def esc(floor, screen, font, protagonist):
    ...
    for i in range(6):
        ...
        screen.blit(pausemain, (96 - 16 * i , 0))
...
def resume(floor, screen, font, protagonist):
    ...
    if 647 <= pos[0] <= 951 and 290 <= pos[1] <= 363 and click[0] == 1:
        for i in range(6):
            ...
            screen.blit(pausemain, (0 + 16 * i, 0))
            pygame.display.update()
        floor.pause = False
...
def update(screen, font, protagonist):
    ...
    text = font[2].render(f"{index[protagonist.screen_number][0]} - {index[protagonist.screen_number][1]}", True, (255, 255, 255))
