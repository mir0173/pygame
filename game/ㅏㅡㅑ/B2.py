...
class B2():
    ...
    def story(self, character_left, character_right):
        ...
        silB = sprite.NPC(self.font, character_left, character_right, 0, 900)
        bul1 = sprite.NPC(self.font, character_left, character_right, 0, 500)
        bul2 = sprite.NPC(self.font, character_left, character_right, 0, 750)
        bul3 = sprite.NPC(self.font, character_left, character_right, 0, 1000)
        bul4 = sprite.NPC(self.font, character_left, character_right, 0, 1250)
        npc_list = [uriel, silB, bul1, bul2, bul3, bul4]
        ...
        while run:
            ...
            if not self.pause:
                ...
                if self.screen_number == 37:
                    before = number
                    if i == 0:
                        number = diaryinter(self.screen, self.font, number, 12, 14, protagonist, npc_list)
                    if before != number:
                        i = 1
                    if i != 0:
                        update(self.screen, self.font, protagonist, npc_list)
                ...
                if self.screen_number == 39:
                    ...
                    if n == 0:
                        ...
                        canmove = False
                        if k == 0:
                            k = protagonist.force_move(self.screen, dt, 0.6, 900, 1)
                            update(self.screen, self.font, protagonist, npc_list)
                        elif k == 1:
                            if m == 0:
                                ...
                                if p == 0:
                                    ...
                                    p = npc_list[1].force_move(self.screen, dt, 0.4, 1500, 0)
                                    update(self.screen, self.font, protagonist, npc_list)
                                elif p == 1:
                                    if q == 0:
                                        q = npc_list[0].force_move(self.screen, dt, 0.4, 800, 1)
                                        update(self.screen, self.font, protagonist, npc_list)
                                    elif q == 1:
                                        if r == 0:
                                            ...
                                            if s == 0:
                                                s = protagonist.force_move(self.screen, dt, 0.4, 500, 1)
                                            elif s == 1:
                                                n = 0
                                                k = 0
                                                m = 0
                ...
                if self.screen_number == 41:
                    before = number
                    if i == 0:
                        number = diaryinter(self.screen, self.font, number, 15, 16, protagonist, npc_list)
                    if before != number:
                        i = 1
                    if i != 0:
                        update(self.screen, self.font, protagonist, npc_list)
