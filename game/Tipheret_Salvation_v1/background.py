...
background_list.append(
    pygame.transform.scale(pygame.image.load('./assets/6-1.png'), (160 * 10, 90 * 10)))  # 6층(튜토리얼) : 7
...
background_list.append(
    pygame.transform.scale(pygame.image.load('./assets/5-1dark.png'), (160 * 10, 90 * 10)))  # 5층 : 12
...
background_list.append(pygame.transform.scale(pygame.image.load('./assets/0-5diary.png'), (160 * 10, 90 * 10)))
background_list.append(pygame.transform.scale(pygame.image.load('./assets/0-5nodiary.png'), (160 * 10, 90 * 10)))
background_list.append(pygame.transform.scale(pygame.image.load('./assets/0-5nodiary.png'), (160 * 10, 90 * 10)))
background_list.append(pygame.transform.scale(pygame.image.load('./assets/2-2open.png'), (160 * 10, 90 * 10)))
background_list.append(pygame.transform.scale(pygame.image.load('./assets/2-2open.png'), (160 * 10, 90 * 10)))
background_list.append(pygame.transform.scale(pygame.image.load('./assets/2-2oopen.png'), (160 * 10, 90 * 10)))
background_list.append(pygame.transform.scale(pygame.image.load('./assets/2-4.png'), (160 * 10, 90 * 10)))

background_list.append(pygame.transform.scale(pygame.image.load('./assets/1-1.png'), (160 * 10, 90 * 10)))
background_list.append(pygame.transform.scale(pygame.image.load('./assets/1-2.png'), (160 * 10, 90 * 10)))
background_list.append(pygame.transform.scale(pygame.image.load('./assets/1-3.png'), (160 * 10, 90 * 10)))
background_list.append(pygame.transform.scale(pygame.image.load('./assets/0-6.jpg'), (160 * 10, 90 * 10)))
background_list.append(pygame.transform.scale(pygame.image.load('./assets/0-6.jpg'), (160 * 10, 90 * 10)))
background_list.append(pygame.transform.scale(pygame.image.load('./assets/1-3.png'), (160 * 10, 90 * 10)))
background_list.append(pygame.transform.scale(pygame.image.load('./assets/0-6.jpg'), (160 * 10, 90 * 10)))
background_list.append(pygame.transform.scale(pygame.image.load('./assets/crack_background.png'), (160 * 10, 90 * 10)))
background_list.append(pygame.transform.scale(pygame.image.load('./assets/1-3.png'), (160 * 10, 90 * 10)))
...
obstacle_list[30] = [pygame.Rect(-500, 775, 2600, 125), pygame.Rect(-500, -100, 2600, 100), 
                     pygame.Rect(310, 0, 1290, 900)]

obstacle_list[51] = [pygame.Rect(-500, 775, 2600, 125), pygame.Rect(-500, -100, 2600, 100),
                     pygame.Rect(0, 525, 381.25, 25), pygame.Rect(1218.75, 525, 381.25, 25),
                     pygame.Rect(500, 650, 600, 25)]

obstacle_list[52] = [pygame.Rect(-500, 775, 2600, 125), pygame.Rect(-500, -100, 2600, 100),
                     pygame.Rect(0, 525, 381.25, 25), pygame.Rect(1218.75, 525, 381.25, 25),
                     pygame.Rect(500, 650, 600, 25)]
