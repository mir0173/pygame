...
class Michael_final():
    def __init__(self, i, target):
        ...
        self.swording = pygame.mixer.Sound('./assets/swording.mp3')
        self.sword_aura_sound = pygame.mixer.Sound('./assets/auraing.mp3')
        self.sword_aura_sound.set_volume(0.5)
        self.sword_gun_shooting_1 = pygame.mixer.Sound('./assets/sword_shot.wav')
        self.sword_gun_shooting_1.set_volume(0.7)
    ...
    def attack(self, screen, target):
        ...
        if self.lr == 0:
            if self.attack_type == 1:
                ...
                self.attack_index += 1
                if self.attack_index == len(self.animation_list_left_1)-15:
                    self.swording.play()
            ...
            if self.attack_type == 3:
                ...
                if self.attack_index == len(self.animation_list_left_2)-20:
                    ...
                    self.sword_gun_shooting_1.play()
