...
Lucy = pygame.image.load('./assets/raphael.png')
...
text = [[0, "으윽...", "여기가... 어디지?", "왜 이렇게 어둡지...? 사고라도 난 건가...", "다친 곳은 없는 것 같으니... 일단 앞으로 가야겠군", 0],
        ...
        [0, "(주인공 이름)님! 살아있으셨군요...!", "전... (주인공 이름)님이 죽은 줄 알았어요...", "그... 미안한데 제가 기억을 잃어서...", "누구신가요...?",
         "그렇군요... 제 이름은 나다니엘이에요... 혹시 기억나시나요...?", "죄송해요... 기억이 쉽게 돌아오지는 않는 것 같아요",
         "괜찮아요... (주인공 이름)님은 저의 상사셨으니 존댓말 하실 필요는 없어요", "혹시 기억이 얼마나 사라진 거예요?",
         "음... 정확하진 않지만 내가 임금 문제로 실험실을 고발한 것까지는 기억나", "그럼 제가 (주인공 이름)님의 연구 기록을 찾아볼 테니, 그걸 한번 봐보는 게 어때요?",
         "연구 기록을 보면 기억이 돌아올 수도 있어요", "좋아", 0],
        [0, "제가 확인해 봤는데, (주인공 이름)님의 연구 기록은 사고에 휘말려 사라진 것 같아요", "하지만 이 컴퓨터에 (주인공 이름)님의 연구 기록이 저장돼있을 거예요", "제가 지금 찾아볼게요",
        ...
        [0, "(주인공 이름)님!", "으... 머리야...", "(주인공 이름)님!! 정신 차려요!!!", "무슨 일이야...?", "(주인공 이름)님이 갑자기 쓰러져서 깜짝 놀랐다고요...",
         "아... 난 괜찮으니까 신경 쓰지 마", "그런데 왜 갑자기 쓰러지신 거예요?", "방금 데이터 세계에 들어가서 내 연구 기록을 보고 왔어", "설마 내가 생체 실험을 했었다니...",
         "나 자신을 용서할 수가 없군...", "그런 소리 하지 마세요...", "전 (주인공 이름)님을 존경해요...", "그 실험은 세상을 위한 일이었으니까요...",
...
name = [[0, "주인공", "주인공", "주인공", "주인공", 0],
        ...
        [0, "주인공", 0],
        [0, "주인공", "주인공", "주인공", 0],
        [0, "루시퍼", "주인공", "루시퍼", "주인공", "루시퍼", "주인공", "루시퍼", "주인공", "주인공", "주인공", "루시퍼", "루시퍼", "루시퍼", "주인공", "주인공",
         "주인공", "주인공", 0],
...
namepos = [[0, texthero, texthero, texthero, texthero, 0],
           ...
           [0, texthero, 0],
           [0, texthero, 0],
           [0, textrucy1, textrucy1, texthero, texthero, textrucy2, texthero, textrucy2, textrucy2, texthero, textrucy2,
            textrucy2, texthero, 0],
           [0, textrucy2, textrucy2, textrucy2, texthero, texthero, 0],
           [0, texthero, texthero, texthero, 0],
           [0, texthero, texthero, 0],
           [0, texthero, 0],
           [0, texthero, texthero, texthero, 0],
           [0, textrucy2, texthero, textrucy2, texthero, textrucy2, texthero, textrucy2, texthero, texthero, texthero,
            textrucy2, textrucy2, textrucy2, texthero, texthero, texthero, texthero, 0],
