...
class Michael():
    def __init__(self, image1, image2, i):
        ...
        self.explosion_image = pygame.image.load('./image/explosion.png')
    ...
    def attack(self, screen, target):
        ...
        if self.attack_type == 3:
            if self.attack_time == 30:
                self.attacking = False
                self.attack_time = 0
            self.explosion_list.update(screen, self.player.centerx, self.player.centery, target)
...
class Explosion(pygame.sprite.Sprite):
    ...
    def update(self, screen, x, y, target):
...
class Michael_final():
    def __init__(self, i, target):
        ...
        self.sword_aura_image_left = pygame.transform.scale(pygame.image.load('./image/aura.png').convert_alpha(), (420, 420)).convert_alpha()
        self.sword_aura_image_right = pygame.transform.flip(self.sword_aura_image_left, True, False)
        self.sword_gun_image_left = pygame.transform.scale(pygame.image.load('./image/sword_gun.png').convert_alpha(), (420, 420)).convert_alpha()
    ...
    def update(self, screen, target):
        if self.health >= 0:
            ...
            self.player_image.set_alpha(self.death_index)
            self.death_index -= 10
            screen.blit(self.player_image, self.player)
            #pygame.time.wait(50)
