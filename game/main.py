...
success_background_4x4 = pygame.transform.scale(pygame.image.load('image/fail_background_4x4.png'), (1600, 900))
success_background_6x6 = pygame.transform.scale(pygame.image.load('image/fail_background_6x6.png'), (1600, 900))
fail_background_4x4 = pygame.transform.scale(pygame.image.load('image/success_background_4x4.png'), (1600, 900))
fail_background_6x6 = pygame.transform.scale(pygame.image.load('image/success_background_6x6.png'), (1600, 900))
clear_background = pygame.transform.scale(pygame.image.load('image/clear_background.png'), (1600, 900))
size_4x4 = (159, 159)
size_6x6 = (106, 106)
