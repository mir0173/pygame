...
# 상호작용 후에는 E키가 사라져야 하는데 구현 방법을 몰라서 못고쳤습니다 ㅠㅠ
# 배경이 안바뀝니다. ㅠㅠㅠㅠ  368줄
            ...
            if not self.pause:
                ...
                if self.screen_number == 28:
                    ...
                    if d5 == 1:
                        ...
                        update(self.screen, self.font, protagonist, npc_list)
                        pygame.display.update()
                        bird_im = pygame.Rect(1200, 650, 300, 100)  # 여기의 E키가 계속 지워지지 않아요
                ...
                if self.screen_number == 29:
                    if n == 0:
                        ...
                        self.screen.blit(bird_image, bird)  # 새랑 E키 사진이랑 겹치는지 깜빡거리는 버그 있음, 그리고 대화할 때 사라짐
                        pygame.display.update()
                    canmove = False
                    if d7 == 0:
                ...
                if self.screen_number == 30:
                    if p == 0:
                        ...
                        self.screen.blit(mole_image, mole)  # 새랑 E키 사진이랑 겹치는지 깜빡거리는 버그 있음, 그리고 대화할 때 사라짐
                        pygame.display.update()
                        canmove = True
                ...
                if self.screen_number == 32:
                    ...
                    if number == -1:
                        ...
                        if d9 == 1:
                            ...
                            pygame.display.update()
                            pygame.time.wait(500)
                            canmove = True  # 여기서 배경이 나오지 않아요 ㅠㅠㅠ
