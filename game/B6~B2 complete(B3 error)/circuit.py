...
third_puzzle = [[(482, 132), 3], [(588, 132), 3], [(694, 132), 2], [(800, 132), 1], [(906, 132), 2], [(1012, 132), 2],
                ...
                [(482, 344), 2], [(588, 344), 0], [(694, 344), 1], [(800, 344), 3], [(906, 344), 2], [(1012, 344), 0],
...
class Circuit(pygame.sprite.Sprite):
    def __init__(self, information, size):
        ...
        empty_images = [pygame.image.load('assets/empty_circuit.png')]
        right_angle_images = [pygame.image.load('assets/right_angle_circuit1.png'),
                              pygame.image.load('assets/right_angle_circuit2.png'),
                              pygame.image.load('assets/right_angle_circuit3.png'),
                              pygame.image.load('assets/right_angle_circuit4.png')]
        t_images = [pygame.image.load('assets/t_circuit1.png'),
                    pygame.image.load('assets/t_circuit2.png'),
                    pygame.image.load('assets/t_circuit3.png'),
                    pygame.image.load('assets/t_circuit4.png')]
        linear_images = [pygame.image.load('assets/linear_circuit1.png'),
                         pygame.image.load('assets/linear_circuit2.png')]
        cross_images = [pygame.image.load('assets/cross_circuit.png')]
        if circuit_number == 0:
            images = empty_images
